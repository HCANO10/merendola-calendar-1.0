...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background-light dark:bg-background-dark text-[#111827] dark:text-white pb-10">
      <header className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-[#1a262f] px-6 md:px-10 py-3 sticky top-0 z-50 shadow-sm">
        ...
        <div className="flex items-center gap-3">
          <div className="relative">
            ...
            {/* ... Notification Dropdown logic remains if needed ... */}
            {showNotifications && (
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full p-6 md:p-8 grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        {/* COLUMNA IZQUIERDA: Calendario Mensual (Mayor espacio) */}
        ...
        <div className="lg:col-span-8 flex flex-col gap-4">
          ...
          <div className="flex-1 min-h-[500px]">
            <MonthCalendar
              viewDate={viewDate}
              events={monthMerendolas} // USES monthMerendolas
        ...
        {/* COLUMNA DERECHA: Próximas Citas (Menor espacio) */}
      ...
      {/* INCLUIR MODALES DE DETALLE Y CREACIÓN (Mismo código que antes, resumido por brevedad en la diff si no cambia) */}
      {/* ... Snack Details Modal ... */}
      {selectedSnackId && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[60] flex items-center justify-center p-4">
          <div className="bg-white dark:bg-[#1a262f] w-full max-w-lg rounded-3xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
            {/* ...Modal Content... (Using store data to find snack) */}
